...
I: Creating roles using 'arn:aws:iam::281359555390:user/wkulhane@redhat.com-dhqc7'
I: Created role 'ManagedOpenShift-Installer-Role' with ARN 'arn:aws:iam::281359555390:role/ManagedOpenShift-Installer-Role'
I: Created role 'ManagedOpenShift-ControlPlane-Role' with ARN 'arn:aws:iam::281359555390:role/ManagedOpenShift-ControlPlane-Role'
I: Created role 'ManagedOpenShift-Worker-Role' with ARN 'arn:aws:iam::281359555390:role/ManagedOpenShift-Worker-Role'
I: Created role 'ManagedOpenShift-Support-Role' with ARN 'arn:aws:iam::281359555390:role/ManagedOpenShift-Support-Role'
...
. Set up some variables and save them in your `.bashrc` for future use.
+
...
----
+
You should notice the state change from "`pending`" to "`installing`" to "ready".
+
...
. To get get (and save) the API URL run:
+
[source,sh,role=copy]
----
