...
[source,sh,role=copy]
----
export IP_JUMPHOST=$(aws ec2 describe-instances \
  --region ${PL_REGION} \
...
. SSH to your jumphost instance, tunneling traffic for the appropriate hostnames. Be sure to use your new/existing private key, the OpenShift DNS for $YOUR_OPENSHIFT_DNS and your jumphost IP for ${YOUR_EC2_IP}
+
[source,sh,role=copy]
----
